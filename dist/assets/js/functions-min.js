...
for (var i = 0; i < num1; i++) {
  ...
  holdModals1.appendChild(div);
}
console.log();
modalContainer1.appendChild(holdModals1);

modalBtn1.addEventListener('click',function(){
  modalContainer1.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer1.classList.add('active1');
  },0.1);
});

closeBtn1.addEventListener('click',function(){
   modalContainer1.classList.remove('active1');
...
var modalBtn2 = document.querySelector('.open2');
var closeBtn2 = document.querySelector('.close2');

var modalContainer2 = document.querySelector('.modals2');
var holdModals2 = document.createDocumentFragment();

for (var i = 0; i < num2; i++) {
  var div = document.createElement('div');
  div.classList.add('modal-drop2');
  div.style.top = Math.floor((Math.random() * 100)) + 'vh';
  div.style.left = Math.floor((Math.random() * 100)) + 'vw';
  div.style.transitionDelay = Math.random() + 's';
  holdModals2.appendChild(div);
}
console.log();
modalContainer2.appendChild(holdModals2);

modalBtn2.addEventListener('click',function(){
  modalContainer2.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer2.classList.add('active2');
  },0.1);
});

closeBtn2.addEventListener('click',function(){
   modalContainer2.classList.remove('active2');
...
var modalBtn3 = document.querySelector('.open3');
var closeBtn3 = document.querySelector('.close3');

var modalContainer3 = document.querySelector('.modals3');
var holdModals3 = document.createDocumentFragment();

for (var i = 0; i < num3; i++) {
  var div = document.createElement('div');
  div.classList.add('modal-drop3');
  div.style.top = Math.floor((Math.random() * 100)) + 'vh';
  div.style.left = Math.floor((Math.random() * 100)) + 'vw';
  div.style.transitionDelay = Math.random() + 's';
  holdModals3.appendChild(div);
}
console.log();
modalContainer3.appendChild(holdModals3);

modalBtn3.addEventListener('click',function(){
  modalContainer3.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer3.classList.add('active3');
  },0.1);
});

closeBtn3.addEventListener('click',function(){
   modalContainer3.classList.remove('active3');
...
var modalBtn4 = document.querySelector('.open4');
var closeBtn4 = document.querySelector('.close4');

var modalContainer4 = document.querySelector('.modals4');
var holdModals4 = document.createDocumentFragment();

for (var i = 0; i < num4; i++) {
  var div = document.createElement('div');
  div.classList.add('modal-drop4');
  div.style.top = Math.floor((Math.random() * 100)) + 'vh';
  div.style.left = Math.floor((Math.random() * 100)) + 'vw';
  div.style.transitionDelay = Math.random() + 's';
  holdModals4.appendChild(div);
}
console.log();
modalContainer4.appendChild(holdModals4);

modalBtn4.addEventListener('click',function(){
  modalContainer4.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer4.classList.add('active4');
  },0.1);
});

closeBtn4.addEventListener('click',function(){
   modalContainer4.classList.remove('active4');
...
var modalBtn5 = document.querySelector('.open5');
var closeBtn5 = document.querySelector('.close5');

var modalContainer5 = document.querySelector('.modals5');
var holdModals5 = document.createDocumentFragment();

for (var i = 0; i < num5; i++) {
  var div = document.createElement('div');
  div.classList.add('modal-drop5');
  div.style.top = Math.floor((Math.random() * 100)) + 'vh';
  div.style.left = Math.floor((Math.random() * 100)) + 'vw';
  div.style.transitionDelay = Math.random() + 's';
  holdModals5.appendChild(div);
}
console.log();
modalContainer5.appendChild(holdModals5);

modalBtn5.addEventListener('click',function(){
  modalContainer5.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer5.classList.add('active5');
  },0.1);
});

closeBtn5.addEventListener('click',function(){
   modalContainer5.classList.remove('active5');
...
var modalBtn6 = document.querySelector('.open6');
var closeBtn6 = document.querySelector('.close6');

var modalContainer6 = document.querySelector('.modals6');
var holdModals6 = document.createDocumentFragment();

for (var i = 0; i < num6; i++) {
  var div = document.createElement('div');
  div.classList.add('modal-drop6');
  div.style.top = Math.floor((Math.random() * 100)) + 'vh';
  div.style.left = Math.floor((Math.random() * 100)) + 'vw';
  div.style.transitionDelay = Math.random() + 's';
  holdModals6.appendChild(div);
}
console.log();
modalContainer6.appendChild(holdModals6);

modalBtn6.addEventListener('click',function(){
  modalContainer6.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer6.classList.add('active6');
  },0.1);
});

closeBtn6.addEventListener('click',function(){
   modalContainer6.classList.remove('active6');
...
var modalBtn7 = document.querySelector('.open7');
var closeBtn7 = document.querySelector('.close7');

var modalContainer7 = document.querySelector('.modals7');
var holdModals7 = document.createDocumentFragment();

for (var i = 0; i < num7; i++) {
  var div = document.createElement('div');
  div.classList.add('modal-drop7');
  div.style.top = Math.floor((Math.random() * 100)) + 'vh';
  div.style.left = Math.floor((Math.random() * 100)) + 'vw';
  div.style.transitionDelay = Math.random() + 's';
  holdModals7.appendChild(div);
}
console.log();
modalContainer7.appendChild(holdModals7);

modalBtn7.addEventListener('click',function(){
  modalContainer7.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer7.classList.add('active7');
  },0.1);
});

closeBtn7.addEventListener('click',function(){
   modalContainer7.classList.remove('active7');
...
var modalBtn8 = document.querySelector('.open8');
var closeBtn8 = document.querySelector('.close8');

var modalContainer8 = document.querySelector('.modals8');
var holdModals8 = document.createDocumentFragment();

for (var i = 0; i < num8; i++) {
  var div = document.createElement('div');
  div.classList.add('modal-drop8');
  div.style.top = Math.floor((Math.random() * 100)) + 'vh';
  div.style.left = Math.floor((Math.random() * 100)) + 'vw';
  div.style.transitionDelay = Math.random() + 's';
  holdModals8.appendChild(div);
}
console.log();
modalContainer8.appendChild(holdModals8);

modalBtn8.addEventListener('click',function(){
  modalContainer8.style.display = 'block';  
  window.setTimeout(function(){
    modalContainer8.classList.add('active8');
  },0.1);
});

closeBtn8.addEventListener('click',function(){
   modalContainer8.classList.remove('active8');
